...
function Plans(){
    return(
        <div>
            <h1>Our Plans</h1>
            <div className="ten flt shadow p-3 mb-5 bg-white rounded">
                ...
                <Link to="/CreateAcc"><Button className="bn">Create Account</Button></Link>
            </div>
            <div className="flt shadow p-3 mb-5 bg-white rounded">
                ...
                <Link to="/PaymentDetails"><Button className="bn">Buy Now</Button></Link>
            </div>
        </div>
    );
}
